...
if (isset($_POST['uploadpic'])) {
        if (((@$_FILES["profilepic"]["type"]=="image/jpeg") || (@$_FILES["profilepic"]["type"]=="image/png") || (@$_FILES["profilepic"]["type"]=="image/gif"))&&(@$_FILES["profilepic"]["size"] < 1048576)) //1 Megabyte
  {
   ...
   else
   {
    ...
    $profile_pic_query = mysql_query("INSERT INTO photos VALUES ('','test','$user','$date','$description','http://localhost/socialnetworkcode2/userdata/user_photos/$rand_dir_name/$profile_pic_name','$img_id','no')");
