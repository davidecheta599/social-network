...
if (isset($_GET['u'])) {
	...
	if ($username != $user) {        //echo the form first b4 u start validating:check below
            ...
            {
				// $send_msg = mysql_query("INSERT INTO pvt_messages (id,user_from,user_to,msg_title,msg_body,date,opened,deleted) VALUES ('','$user','$username','$msg_title','$msg_body','$date','$opened','$deleted')");
