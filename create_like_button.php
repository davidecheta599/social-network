...
if (isset($_POST['like_button_url'])) {
 ...
 $like_button_url2 = strstr($like_button_url, 'http://');  // checking if http:// is not in the type url textbox else
	 //  $like_button_url = "http://".$like_button_url; meaning by default http:// we start up every word type in the url box
...
if ($numrows_check >= 1) {
 ...
 &lt;iframe src='http://localhost/socialnetworkcode2/like_but_frame.php?uid=$uid' style='border: 0px;height: 23px; width: 110px;'&gt;
